...
<body onload="updateSQL()"></body>
  ...
  <div style="width: 100%; overflow: hidden;">
    ...
    ?>
    <form action="login.php" method="post" style="margin-left: 10px; margin-top: 40px; margin-bottom: 10px; border: 1px solid black; padding: 10px; border-radius: 5px;">
  ...
  <!-- fixed button to go to register page, that says register -->
  <div class="fixed-action-btn" style="top: 10px; right: 10px;">
    <a class="btn-floating btn-large waves-effect waves-light" href="register_form.php">
      <i class="large mdi mdi-account-plus"></i>
    </a>
  </div>
  </main>
</body>
